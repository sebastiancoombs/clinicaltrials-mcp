...
const PAID_GET_PATHS = new Set(["/v1/trials/search", "/v1/trials/by_nct", "/v1/sponsors/pipeline"]);
...
function endpointInfo(c, path) {
  ...
  return {
    ...
    network: NETWORK,
    pay_to: PAY_TO || null,
    hint: "GET this path with query parameters and an x402 payment. HEAD is an unpaid metadata check; trailing slashes redirect to the canonical path.",
  };
}
